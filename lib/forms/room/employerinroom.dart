...
class EmployerInRoom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool issuperadmin = adminProv.adminusers
        .any((user) => user.emailid == lProvider.logedinUser.workemail);
        ...
        : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Column(
              ...
              children: [
                Align(
                  alignment: Alignment
                      .topLeft, // Align the icon to the top right corner
                  child: IconButton(
                    icon: const Icon(
                      Icons.menu,
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          GestureDetector(
                                            ...
                                            child: prvView.readingLaunchPack
                                                ? displaySpin()
                                                : CustomLogoViewer(
                                                    employer: prvView
                                                        .employers[index]),
