                            ...
                            children: [
                              ...
                              Consumer<EmployerProvider>(
                                ...
                                return ElevatedButton(
                                    ...
                                    child: prvText.updatelaunchstatus
                                        ? displaySpin()
                                        : getTextValue(selectedEmployer));
                              }),
                            ],
                          ),
                        ),
                                                                        ...
                                                                        Center(
                                                                          child: Consumer<EmployerProvider>(builder: (context,
                                                                            ...
                                                                            return DropdownButton<LaunchStatus>(
                                                                              value: prvLS.launchStatusList.firstWhere((element) => element.code == prvDis.launchpacks[i].formstatus, orElse: () => prvLS.launchStatusList.firstWhere((element) => element.key == prvLS.launchpacks[i].attachmenttype)),
                                                                      ...
                                                                      children: [
                                                                        DropdownButton<
                                                                          ...
                                                                          value: prvNew.attachmentTypeList.firstWhere((element) =>
                                                                              element.code ==
                                                                              prvNew.actionlaunchpacks[i].attachmenttype),
                                                                          onChanged:
                                                                              (newValue) {
                                                                            prvNew.setAttachmentType(i,
                                                                                newValue!);
                                                                            (newValue.code == "esign")
                                                                                ? EliteDialog(context, 'Alert', 'Please note that once the document is sent for eSign, the sender or the receiver won’t be able to change signatories. If signatories need to be changed, you can send a new document for eSign.', 'Ok', 'Close')
                                                                                : null;
                                                                          },
                                                                          items: prvNew
                                                                              .attachmentTypeList
                                                                        ...
                                                                        prvNew.actionlaunchpacks[i].newAction &&
                                                                                (prvNew.actionlaunchpacks[i].attachmenttype == 'esign' || prvNew.actionlaunchpacks[i].attachmenttype == 'file')
                                                                            ? IconButton(
                                                                                icon: const Icon(FontAwesomeIcons.paperclip),
                                                                                onPressed: (prvNew.actionlaunchpacks[i].formcode.isNotEmpty)
                                                                                    ? null
                                                                                    : () async {
                                                                                        ActionLaunchPack obj = prvNew.actionlaunchpacks[i];
                                                                                        await prvNew.pickFile(obj, i);
                                                                                      },
                                                                              )
                                                                            : Center(
                                                                                child: prvNew.actionlaunchpacks[i].attachmenttype == 'esign'
                                                                                    ? Tooltip(
                                                                                        ...
                                                                                        child: IconButton(
                                                                                          iconSize: 20,
                                                                                          onPressed: () async {
                                                                                            await prvNew.generateESignEmbeddedURL(prvNew.actionlaunchpacks[i].esigndocumentdata.esigndocumentid, prvNew.actionlaunchpacks[i].esigndocumentdata.formdefinitionid).then((value) {
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                            (prvNew.assistDueDate == null)
                                                                                ...
                                                                                : DateFormat('MM-dd-yyyy').format(prvNew.assistDueDate!),
                                                                            style: const TextStyle(fontSize: 12)),
                                                                        IconButton(
                                                                            onPressed:
                                                                                () async {
                                                                              prvNew.assistDueDate = await showDatePicker(
                                                                                context: context,
                                                                                initialDate: prvNew.assistDueDate!,
                                                                    ...
                                                                    child: prvNew
                                                                        ...
                                                                        : IconButton(
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              ActionLaunchPack obj = ActionLaunchPack(filebase64: prvNew.actionlaunchpacks[i].filebase64, fileextension: prvNew.actionlaunchpacks[i].fileextension, formcode: '', formname: prvNew.actionlaunchpacks[i].formname, launchpack: false, renewalpack: false, filename: prvNew.actionlaunchpacks[i].filename, attachmenttype: prvNew.actionlaunchpacks[i].attachmenttype, contentmimetype: prvNew.actionlaunchpacks[i].contentmimetype, esigndocumentdata: ESignDocument(esigndocumentid: '', formdefinitionid: ''));
                                                                              lists.add(obj);

                                                                              if (obj.fileextension.isEmpty && (obj.attachmenttype == 'esign' || obj.attachmenttype == 'file')) {
                                                                                EliteDialog(context, "Alert", "Please attach a valid document.", "Ok", "Cancel");
                                                                                return;
                                                                              }

                                                                              AccountAction objAct = AccountAction(accountcode: selectedEmployer.accountcode, employercode: selectedEmployer.employercode, formfileupload: lists);

                                                                              await prvNew.saveActionLaunchPack(objAct, i).then((value) async {
                                                                                //write code to insert directly in launchpack for this employer only.
                                                                                ActionLaunchPack objNewAdded = prvNew.actionlaunchpacks[i];
                                                                                LaunchPack obj = LaunchPack(accountowners: [], esigndocumentdata: ESignDocument(esigndocumentid: '', formdefinitionid: ''));
                                                                                obj.formcode = objNewAdded.formcode;
                                                                                obj.fromcode = prvNew.selectedFromAssist!.account.accountcode;
                                                                                obj.tocode = prvNew.selectedToAssist!.account.accountcode;
                                                                                obj.accountcode = selectedEmployer.accountcode;
                                                                                obj.employercode = selectedEmployer.employercode;
                                                                                obj.launchcode = prvNew.launchpacks[0].launchcode;
                                                                                obj.duedate = DateFormat('yyyy-MM-dd').format(prvEmployer.assistDueDate!);
                                                                                obj.attachmenttype = objNewAdded.attachmenttype;

                                                                                if (objNewAdded.attachmenttype == 'esign') {
                                                                                  obj.formstatus = selectedEmployer.launchstatus == 'INITIATE' ? 'esignnotsent' : 'esigninprogress';
                                                                                }
                                                                                if (objNewAdded.attachmenttype == 'file') {
                                                                                  obj.formstatus = selectedEmployer.launchstatus == 'INITIATE' ? 'notsent' : 'InProgress';
                                                                                }
                                                                                if (objNewAdded.attachmenttype == 'none') {
                                                                                  obj.formstatus = selectedEmployer.launchstatus == 'INITIATE' ? 'none' : 'noneinprogress';
                                                                                }

                                                                                obj.visibility = (prvNew.selectedVisibilityStatus) ? 'private' : 'public';

                                                                                var objMail = NewActionItemMail();
                                                                                objMail.toRecipientEmailId = prvNew.selectedToAssist!.account.workemail;
                                                                                objMail.employerCompanyName = selectedEmployer.companyname;
                                                                                if (objNewAdded.attachmenttype == "esign") {
                                                                                  await prvNew.generateESignEmbeddedURL(prvNew.actionlaunchpacks[i].esigndocumentdata.esigndocumentid, prvNew.actionlaunchpacks[i].esigndocumentdata.formdefinitionid).then((value) {
                                                                                    prvNew.viewIframe = true;
                                                                                  });
