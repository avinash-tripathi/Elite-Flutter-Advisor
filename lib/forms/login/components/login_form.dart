...
class LoginForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool superAdminExist = (adminProv.adminusers.isNotEmpty);
        ...
        child: Center(
          child: Form(
            ...
            child: SingleChildScrollView(
              child: !superAdminExist
                  ? const Text(
                      "Dear User\n No administrative configuration found.\n Please connect with your Account Owner.",
                      style: appstyle,
                    )
                  : Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: Consumer<LoginProvider>(
                                builder: (context, prvLgn, child) {
                              return prvLgn.verifying
                                  ? displaySpin()
                                  : ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        if (formKey.currentState!.validate()) {
                                          try {
                                            ...
                                            /*   final rProv = Provider.of<RoomsProvider>(context,
                                  listen: false); */
                                            final sideProv =
                                            ...
                                            if (!lgnProvider.verifying) {
                                              ...
                                              if (res.accountcode
                                                  ...
                                                  res.invitationstatus
                                                          .toUpperCase() !=
                                                      'EXPIRED') {
                                                await lgnProvider
                                                    .setLoggedInCredential(res);
                                                sideProv.selectedMenu =
                                                    'Account';

                                                /*  await rProv.getInitialLaunchPack(
                                      lgnProvider.logedinUser.accountcode,
                                      '',
                                      'Individual');
                                  await rProv.readRooms(
                                      lgnProvider.logedinUser.workemail); */

                                                Navigator.pushNamed(
                                                    context, "/companyProfile");
                                              } else if (res.accountcode
                                                          .trim()
                                                          .length >
                                                      1 &&
                              ...
                              children: [
                                TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()
                                    ..onTap = () {
                                      launchUrl(
                                          Uri.parse('https://alicorn.co/terms'),
